...
/*                                                   +#+        +#+    +#+ +#+              */
/* Created: 2022/12/08 14:54:11 by Flavio BC        #+#        #+#    #+# #+#    #+#        */
/* Updated: 2022/12/08 17:07:02 by Flavio BC       ###        #########   ########          */
/* License: MIT                                                                             */
/*                                                                                          */
/* **************************************************************************************** */
...
int	main(void) {
	...
	std::cout << std::boolalpha << std::endl << "*************** STD::VECTOR TEST ***************" << std::endl << std::endl;
	...
	std::cout << std::endl << "STD Execution time: " << std::fixed << (double)(end - start) << " miliseconds" << std::endl;
	std::cout << std::endl << std::fixed << (double)(end - start) << std::endl;
	return (0);
}
