...
/*                                                   +#+        +#+    +#+ +#+              */
/* Created: 2022/12/08 14:54:08 by Flavio BC        #+#        #+#    #+# #+#    #+#        */
/* Updated: 2022/12/08 17:06:53 by Flavio BC       ###        #########   ########          */
/* License: MIT                                                                             */
/*                                                                                          */
/* **************************************************************************************** */
...
int	main(void) {
	...
	std::cout << std::boolalpha << std::endl << "*************** FT::VECTOR TEST ***************" << std::endl << std::endl;
	...
	std::cout << std::endl << "FT Execution time: " << std::fixed << (double)(end - start) << " miliseconds" << std::endl;
